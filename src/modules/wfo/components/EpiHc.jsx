...
function buildHBarChart(entries, color, textColor) {
  return {
    ...
    options: {
      ...
      scales: { x: { beginAtZero: true, grace: '15%', grid: { display: false } }, y: { ticks: { font: { size: 10 } } } },
    },
  }
}
...
function buildStatusChart(entries, statusColors, textColor) {
  return {
    ...
    options: {
      ...
      maintainAspectRatio: false,
      plugins: { legend: { display: false } },
      scales: { x: { ticks: { font: { size: 9 }, maxRotation: 20, minRotation: 0 }, grid: { display: false } }, y: { beginAtZero: true, grace: '10%' } },
    },
  }
}
